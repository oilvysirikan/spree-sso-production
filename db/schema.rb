...
ActiveRecord::Schema[8.1].define(version: 2026_05_08_041438) do
  ...
  create_table "social_accounts", force: :cascade do |t|
    ...
    t.string "uid"
    t.datetime "updated_at", null: false
    t.index ["spree_user_id"], name: "index_social_accounts_on_spree_user_id"
  end
  ...
  add_foreign_key "social_accounts", "spree_users"
